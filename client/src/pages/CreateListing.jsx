            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1 '>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type='number' id='regularPrice' min='1' max='10' required className='p-3 border-gray-300 rounded-lg'></input>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type='number' id='discountedPrice' min='1' max='10' required className='p-3 border-gray-300 rounded-lg'></input>
                            <div className='flex flex-col items-center '>
